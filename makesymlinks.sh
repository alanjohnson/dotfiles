...
files="bash_profile profile bashrc gitconfig gitignore git-completion git-completion.bash vim vimrc eslintrc" # list of files/folders to symlink in homedir
